...
struct AnimationImpl
{
  ...
  AnimationImpl(asio::io_context& io)
    : io_(io)
  {
  }
...
Animation::Animation(asio::io_context& io)
  : impl_(new AnimationImpl(io))
{
}
Animation::~Animation()
{
...
void
Animation::SetBvh(const std::shared_ptr<libvrm::bvh::Bvh>& bvh)
{
  impl_->SetBvh(bvh);
}
void
Animation::OnFrame(const OnFrameFunc& onFrame)
{
